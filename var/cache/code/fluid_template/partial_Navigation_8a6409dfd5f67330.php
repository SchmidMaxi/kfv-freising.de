<?php
class partial_Navigation_8a6409dfd5f67330 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '
  <nav class="navbar navbar-expand-lg bg-body">
    <div class="container-fluid">
      ...
      <div class="collapse flex-column navbar-collapse" id="navbarContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 order-lg-last">
          ';
