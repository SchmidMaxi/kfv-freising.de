...
/**
 * Extension: kfv_template
 * File: /var/www/html/vendor/maxi-schmid/kfv-template/ext_localconf.php
 */
 ...
 */
$GLOBALS['TYPO3_CONF_VARS']['RTE']['Presets']['kfv_template'] = 'EXT:kfv_template/Configuration/RTE/Default.yaml';

/***************
 * PageTS
 */
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPageTSConfig('<INCLUDE_TYPOSCRIPT: source="FILE:EXT:kfv_template/Configuration/TsConfig/Page/All.tsconfig">');
}


/**
 * Extension: scss_compiler
 * File: /var/www/html/vendor/trion/scss-compiler/ext_localconf.php
 */
